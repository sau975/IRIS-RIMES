...
export class FrontPageComponent {
  ...
  //   console.log(this.fetchedData2, "ooooo")
  //   for (const item of this.fetchedData2) {
  ...
  //     }
  //     else {
  //       if (previoussubdivId !== null && previoussubdivId === item['subdivid']) {
  ...
  //   console.log(this.fetchedData5, "hhhhhh")
  ...
  //     });
  //     console.log(this.subdivisionfetchedDatadaily, "kkkkk")
  ...
  //   console.log(sortedData, groupedData, "district data")
  ...
  //   console.log(this.subdivisionfetchedDatadep)
  //   const data = this.subdivisionfetchedDatadep.sort((a, b) => {
  //     return a.regionid - b.regionid;
  //   });
  ...
  //   const exclusionClasses = ['download', 'downloadpdf'];
