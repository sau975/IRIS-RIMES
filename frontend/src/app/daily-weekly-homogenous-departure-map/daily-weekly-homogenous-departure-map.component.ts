...
@Component({
  selector: 'app-daily-weekly-homogenous-departure-map',
  templateUrl: './daily-weekly-homogenous-departure-map.component.html',
  styleUrls: ['./daily-weekly-homogenous-departure-map.component.css']
})
export class DailyWeeklyHomogenousDepartureMapComponent implements OnInit, AfterViewInit {
